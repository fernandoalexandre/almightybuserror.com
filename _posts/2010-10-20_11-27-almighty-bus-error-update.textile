...
<div class="standard_div">
    <div style="width:45%; float:left">
        Before:
        <a href="/images/posts/old.png" class="lightbox" id="img"><img src="/images/posts/old.png" style="width:100%"/></a>
    </div>
    <div style="width:45%; float:right">
        After:
        <a href="/images/posts/new.png" class="lightbox" id="img"><img src="/images/posts/new.png" style="width:100%"/></a>
    </div>
</div>
